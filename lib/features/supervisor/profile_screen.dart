...
class SupervisorProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final user = store.currentUser ?? const AppUser(id: '0', name: 'Supervisor', role: UserRole.admin);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildProfileItem(Icons.email_outlined, 'Email Address', 'supervisor@tm.com.my'),
                  _buildProfileItem(Icons.phone_outlined, 'Staff ID', 'TM-99821'),
                  _buildProfileItem(Icons.business_outlined, 'Department', 'Network Operations'),
